...
requests.post('https://semmle.com', False) # BAD
requests.post('https://semmle.com', 0) # BAD

# Simple flow
put = requests.put
put('https://semmle.com', verify="/path/to/cert/") # GOOD
put('https://semmle.com', verify=False) # BAD
put('https://semmle.com', False) # BAD
put('https://semmle.com', 0) # BAD
put('https://semmle.com', verify=0) # BAD
